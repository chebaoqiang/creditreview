    ...
    <div class="login">
      ...
      <el-form :model="loginForm" ref="loginForm" :rules="rules">
        ...
        <el-form-item label="" prop="password">
          <el-input prefix-icon="el-icon-s-cooperation" suffix-icon="el-icon-view" class="login-input-text" type="password" v-model="loginForm.password" placeholder="密码" ></el-input>
        </el-form-item>
        <el-form-item>
