  ...
  <div class="loan-approve-first">
    ...
    <div class="input-manager-table">
      <el-table :data="lists" style="width: 100%">
        <el-table-column fixed prop="loan_name" label="姓名" align="left" ></el-table-column>
        <el-table-column prop="modified" label="出生日期" align="left" >
          <template slot-scope='scope'>
            <span>
              {{scope.row.modified |getBirthday}}
            </span>
          </template>
        </el-table-column>
        <el-table-column prop="loan_card" label="身份证" align="left" ></el-table-column>
...
export default {
  ...
  methods: {
    ...
    // 查看详情
    handleDetails (row) {
      loanEndQuery({id:row.loan_id}).then(res=>{
        console.log(res);
        if (res.code === 20000) {
